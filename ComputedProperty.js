...
function ComputedProperty() {
	...
	this.dependsOn = [];
	this.hasCustomGet = true;
}

ComputedProperty.prototype = Object.create(Property.prototype);
...
ComputedProperty.prototype._get = function () {
...
ComputedProperty.prototype._has = function () {
	return true;
};

ComputedProperty.prototype._addListener = function (listener) {
