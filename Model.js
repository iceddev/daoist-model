...
function mixin(dst, src) {
	...
	for(name in src){
		s = src[name];
		if(!(name in dst) || (dst[name] !== s
			&& (!(name in emptyObject) || emptyObject[name] !== s))){
			dst[name] = s;
		}
	}
}
...
Model.prototype._setValues = function (values) {
	return mixin(this, values);
};

Model.prototype._getValues = function () {
	return this._values || this;
};

Model.prototype.save = function (/*Object*/ options) {
	//	summary:
...
Model.prototype.prepareForSerialization = function () {
	//	summary:
...
Model.prototype.createValidationError = function (errors) {
	//	summary:
...
Model.prototype.property = function (/*String...*/ key, nextKey) {
	//	summary:
...
Model.prototype.get = function (/*string*/ key) {
...
Model.prototype.set = function (/*string*/ key, /*any?*/ value) {
	//	summary:
...
Model.prototype.observe = function (/*string*/ key, /*function*/ listener, /*object*/ options) {
	//	summary:
...
Model.prototype.validate = function (/*string[]?*/ fields) {
	//	summary:
...
Reactive.prototype._addListener = function (listener) {
	// add a listener for the property change event
	return meld.on(this, 'onchange', listener);
};

Reactive.prototype.valueOf = function () {
	return this._get();
};

Reactive.prototype._get = function () {
	return this.value;
};

Reactive.prototype._has = function () {
	return this.hasOwnProperty('value');
};

Reactive.prototype.setValue = function (value) {
	//	summary:
...
Reactive.prototype.put = function (/*any*/ value) {
	//	summary:
...
Reactive.prototype.coerce = function (value) {
	//	summary:
...
Reactive.prototype.addError = function (error) {
	//	summary:
...
Reactive.prototype.checkForErrors = function (value) {
	//	summary:
...
Reactive.prototype._queueChange = function (callback, oldValue) {
...
Reactive.prototype.toJSON = function () {
	return this._values || this;
};
...
function Property() {
	Reactive.apply(this, arguments);
}

Property.prototype = Object.create(Reactive.prototype);
Property.prototype.constructor = Property;

Property.prototype.init = function (options) {
...
Property.prototype._has = function () {
	return this.name in this._parent._getValues();
};

Property.prototype.setValue = function (value, parent) {
